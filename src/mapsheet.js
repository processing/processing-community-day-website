(function(global) {
  ...
  Mapsheet.Point.prototype = {    
		...
		Lat: function() {
			return parseFloat( this.model["Lat"] || this.model["lat"] );
		},

		Lng: function() {
			return parseFloat( this.model["Lng"] || this.model["lng"] || this.model["long"] );
		},
	...
	*/
	...
	Mapsheet.Providers.MapQuest.prototype = {
		...
		drawMarker: function(point) {
		  var marker = new MQA.Poi( { lat: point.Lat(), lng: point.Lng() } );
	...
	*/
	...
	Mapsheet.Providers.Leaflet = function(options) {
		...
		var attribution = 'Map data &copy; <a href="https://openstreetmap.org">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, tiles &copy; <a href="https://www.mapquest.com/" target="_blank">MapQuest</a> <img src="https://developer.mapquest.com/content/osm/mq_logo.png" />';
